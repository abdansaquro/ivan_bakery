...
if($_GET['anggota'] == "tambah"){
	...
	if($nama == "" or $jk == "" or $no_hp == "" or 
		...
		echo "	<script>alert('Berhasil disimpan');
					window.location='index2.php2.php?hal=anggota'
				</script>";			
	}
	...
	if($nama == "" or $jk == "" or $no_hp == "" or 
		...
		echo "	<script>alert('Berhasil disimpan');
					window.location='index2.php.php?hal=anggota'
				</script>";			
	}
	...
	if($kategori == ""){
		...
		echo "	<script>alert('Berhasil disimpan');
						window.location='index2.php.php?hal=kategori'
					</script>";		
	}
	...
	echo "	<script>alert('Berhasil dihapus');
		...
		if (!empty($nama_file)){
			if(!copy($temp,"image/".$nama_file)){
				echo "<script>alert('gambar harus di upload..'); window.location = 'index2.php.php?page=datafs'</script>";
				exit;
			}
		}
		...
		if($nama_barang == "" or $nama_file == "" or $id_kategori == "" or
			...
			$save = mysql_query("insert into barang values(
				...
				echo "<script>alert('Data disimpan'); window.location = 'index2.php.php?hal=barang'</script>";				
	...
	echo "	<script>alert('Berhasil dihapus');
					window.location='index2.php.php?hal=barang'
				</script>";	 
	...
	if($kota == "" or $ongkir == ""){
		...
		echo "	<script>alert('Berhasil disimpan');
					window.location='index2.php.php?hal=kota'
				</script>";		
	}
	...
	if($nama_bank == "" or $no_rek == "" or $atas_nama == ""){
		...
		echo "	<script>alert('Berhasil disimpan');
						window.location='index2.php.php?hal=rekening'
					</script>";	
	}
