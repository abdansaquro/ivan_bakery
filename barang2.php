...
<div class="row">
			...
			<?php
				...
				$detail	= "index2.php?hal=detail_barang&id_barang=".$row['id_barang'];
  ...
  <div class="col-md-4" align="center">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p ><a href="#" class="btn btn-default" role="button"><?php echo $row['kategori'];?></a> <a href="<?php echo $detail ?>" class="btn btn-info"><span class="glyphicon glyphicon-list"></span> Detail</a></p>
      </div>
    </div>
  </div>
